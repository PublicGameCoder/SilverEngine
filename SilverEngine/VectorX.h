...
public:
	...
	*/
	...
	/**
	* @brief Converts glm::vec2 to Vector2.
	*
	* @param rhs
	* The glm::vec2 to parse into Vector2
	*
	* @return VectprX<T>
	* The Vector2
	*/
	static const VectorX_t<T> fromVec( glm::vec2& rhs );

	/**
	* @brief Converts glm::vec3 to Vector3.
	*
	* @param rhs
	* The glm::vec3 to parse into Vector3
	*
	* @return VectprX<T>
	* The Vector3
	*/
	static const VectorX_t<T> fromVec( glm::vec3& rhs );

	/**
	* @brief Converts this Vector to glm::vec2.
	*
	* @return glm::vec2
	* The glm::vec2
	*/
	const glm::vec2 toVec2();

	/**
	* @brief Converts this Vector to glm::vec3.
	*
	* @return glm::vec3
	* The glm::vec3
	*/
...
// fromVec()
template <class T>
static const VectorX_t<T> VectorX_t<T>::fromVec( glm::vec2& rhs ) {
	return VectorX_t<T>( rhs.x, rhs.y );
}

// fromVec()
template <class T>
static const VectorX_t<T> VectorX_t<T>::fromVec( glm::vec3& rhs ) {
	return VectorX_t<T>( rhs.x, rhs.y, rhs.z );
}

// toVec2()
template <class T>
const glm::vec2 VectorX_t<T>::toVec2() {
	return glm::vec2( x, y );
}
